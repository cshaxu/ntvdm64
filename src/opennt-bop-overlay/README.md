...
| `BOP-DIV-107` | XMS package configuration, copied-call validation and scoped CCPU/SAS composition surround the original XMS services. | OpenNT has no independently composable source unit for that NT4 product lifecycle. | `xms/opennt_xms_composition.c` includes this private body only. |
