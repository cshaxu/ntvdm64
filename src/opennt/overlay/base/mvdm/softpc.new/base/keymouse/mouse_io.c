...
/* Default-disabled bounded startup trace; no mouse behavior is replaced. */
#ifdef NTDOS64_MOUSE_INIT_TRACE
extern void ntdos64_host_applinit_trace_checkpoint(int stage);
#define NTDOS64_MOUSE_INIT_STAGE(stage) \
   ntdos64_host_applinit_trace_checkpoint(stage)
#else
#define NTDOS64_MOUSE_INIT_STAGE(stage) ((void)0)
#endif
/*
 * SoftPC Revision 3.0
 *
...
GLOBAL void mouse_driver_initialisation IFN0()
   ...
   NTDOS64_MOUSE_INIT_STAGE(6327);

#ifdef HERC
   HERC_graphics_virtual_screen.top_left.x = 0;
   NTDOS64_MOUSE_INIT_STAGE(63271);
   HERC_graphics_virtual_screen.top_left.y = 0;
   NTDOS64_MOUSE_INIT_STAGE(63272);
   HERC_graphics_virtual_screen.bottom_right.x = 720;
   NTDOS64_MOUSE_INIT_STAGE(63273);
   HERC_graphics_virtual_screen.bottom_right.y = 350;
   NTDOS64_MOUSE_INIT_STAGE(63274);
#endif /* HERC */

   NTDOS64_MOUSE_INIT_STAGE(6328);
   cursor_EM_disabled = FALSE;
   NTDOS64_MOUSE_INIT_STAGE(6329);
   NTDOS64_MOUSE_INIT_STAGE(633);
   }
