...
#ifdef NTDOS64_BYOB_NTIO
extern BOOL ntdos64_byob_ntio_path(CHAR *destination, DWORD destination_size);
#endif
#ifdef NTDOS64_SESSION_TRACE_IO_INIT
extern VOID ntdos64_session_trace_io_init(VOID);
#endif
#ifdef NTDOS64_SESSION_TRACE_AFTER_IO_INIT
extern VOID ntdos64_session_trace_after_io_init(VOID);
#endif
#ifdef NTDOS64_SESSION_TRACE_AFTER_RESET
extern VOID ntdos64_session_trace_after_reset(VOID);
#endif
#ifdef NTDOS64_SESSION_TRACE_BEFORE_RESET
extern VOID ntdos64_session_trace_before_reset(VOID);
#endif
#ifdef NTDOS64_SESSION_TRACE_VINT
extern VOID ntdos64_session_trace_vint_checkpoint(int stage);
#endif
...
InitialiseDosEmulation(int argc, char **argv)
{
...
#ifdef NTDOS64_SESSION_TRACE_VINT
    ntdos64_session_trace_vint_checkpoint(1);
#endif
...
#ifdef NTDOS64_SESSION_TRACE_VINT
    ntdos64_session_trace_vint_checkpoint(2);
#endif
#ifndef i386
...
#ifdef NTDOS64_SESSION_TRACE_VINT
    ntdos64_session_trace_vint_checkpoint(3);
#endif

#ifdef NTDOS64_SESSION_TRACE_IO_INIT
     ntdos64_session_trace_io_init();
#elif defined(NTDOS64_SESSION_TRACE_AFTER_IO_INIT)
     io_init();
    ...
    /*................................................... Execute reset */
#ifdef NTDOS64_SESSION_TRACE_BEFORE_RESET
    ntdos64_session_trace_before_reset();
#endif
#ifdef NTDOS64_SESSION_TRACE_AFTER_RESET
    reset();
...
#ifdef NTDOS64_BYOB_NTIO
     if (!ntdos64_byob_ntio_path(buffer, sizeof(buffer))) {
         host_error(EG_OWNUP, ERR_QUIT, "NTVDM:InitialiseDosEmulation needs NTDOS64_NTIO_PATH");
         return (-1);
     }
#else
