...
/* SoftPC's one-argument tone helper predates the WinMM PlaySound API. Keep
 * the original helper and its in-unit call graph private to this source. */
#define PlaySound ntdos64_softpc_PlaySound
