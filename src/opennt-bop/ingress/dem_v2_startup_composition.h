#ifndef RUNTIME_BOP_DEM_V2_STARTUP_COMPOSITION_H
#define RUNTIME_BOP_DEM_V2_STARTUP_COMPOSITION_H
...
int runtime_dem_v2_startup_install(const uint16_t *profile, uint32_t profile_chars,
