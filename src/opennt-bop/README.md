...
| `BOP-DIV-033` | COMMAND maps NTSTATUS through the NT4 ntdll import. | The historical import is not a stable application dependency. | Preserve its same-named modern-export/fallback facade until this helper is extracted to `adapter-win32`. | `command/opennt_command_binary_composition.c:78` |
