 ...
 * DIVERGENCE: historical NT header composition is replaced only by xms_shim.h;
 ...
 * closure; restate only this unchanged source constant locally. */
#define COMMIT_GRANULARITY 4096u
