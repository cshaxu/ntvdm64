#ifndef RUNTIME_NTDOS_EXEC_OBSERVATION_H
#define RUNTIME_NTDOS_EXEC_OBSERVATION_H
 ...
 * sole owner.
 */
#define RUNTIME_NTDOS_EXEC_OBSERVATION_MAGIC UINT32_C(0x4258454f)
#define RUNTIME_NTDOS_EXEC_OBSERVATION_VERSION UINT32_C(1)
...
struct runtime_ntdos_exec_observation {
    uint32_t magic;
