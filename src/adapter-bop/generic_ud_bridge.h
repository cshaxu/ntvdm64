...
#define RUNTIME_GENERIC_UD_EVENT_V1_MAGIC 0x42585544u
#define RUNTIME_GENERIC_UD_EVENT_V1_VERSION 1u
...
#define RUNTIME_GENERIC_UD_OUTCOME_V2_VERSION 2u
...
enum runtime_generic_ud_disposition_v1 {
...
struct runtime_generic_ud_outcome_v2 {
  uint32_t abi_version, disposition;
  uint64_t resume_rip;
...
int runtime_mantle_generic_ud_bridge_v2(
  const struct runtime_generic_ud_event_v1 *event,
 ...
 * watchdog timer. */
void runtime_mantle_generic_ud_stop_observation_reset(void);
void runtime_mantle_generic_ud_stop_observation_mark(void);
int runtime_mantle_generic_ud_stop_observed(void);
void runtime_mantle_generic_ud_pending_observation_reset(void);
void runtime_mantle_generic_ud_pending_observation_mark(void);
int runtime_mantle_generic_ud_pending_observed(void);
