#ifndef RUNTIME_GUEST_GATHER_READ_ACTION_V1_H
#define RUNTIME_GUEST_GATHER_READ_ACTION_V1_H
...
#define RUNTIME_GUEST_GATHER_READ_ACTION_V1_MAGIC 0x42584747u
#define RUNTIME_GUEST_GATHER_READ_ACTION_V1_VERSION 2u
#define RUNTIME_GUEST_GATHER_READ_ACTION_V1_MAX_RANGES 4u
...
#define RUNTIME_GUEST_GATHER_READ_ACTION_V1_MAX_TOTAL_BYTES 520u

enum runtime_guest_gather_read_action_v1_disposition {
    RUNTIME_GUEST_GATHER_READ_ACTION_V1_PASS_THROUGH = 0u,
    RUNTIME_GUEST_GATHER_READ_ACTION_V1_RESUME = 1u,
    RUNTIME_GUEST_GATHER_READ_ACTION_V1_NEED_READ = 2u,
    RUNTIME_GUEST_GATHER_READ_ACTION_V1_STOP = 3u
};

typedef struct runtime_guest_gather_read_action_v1 {
...
} runtime_guest_gather_read_action_v1;
...
int runtime_guest_gather_read_action_v1_stop(runtime_guest_gather_read_action_v1 *action);
