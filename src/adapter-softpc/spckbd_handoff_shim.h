#ifndef BX_NTVDM_BOP_SHIM_SPCKBD_HANDOFF_SHIM_H
#define BX_NTVDM_BOP_SHIM_SPCKBD_HANDOFF_SHIM_H
...
void bx_ntvdm_spckbd_handoff_fail(void);
int bx_ntvdm_spckbd_handoff_failed(void);
