...
static struct runtime_interrupt_return_observation_v1_record
  runtime_interrupt_return_observation_records[
    RUNTIME_INTERRUPT_RETURN_OBSERVATION_V1_CAPACITY_MAX];
...
{
  if (capacity > RUNTIME_INTERRUPT_RETURN_OBSERVATION_V1_CAPACITY_MAX)
    return 0;
