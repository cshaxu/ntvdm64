...
/* One declared target spans COMMAND's 54:01 launch envelope and 54:11
 * completion.  The retained exit code is a copied guest value, not a Win32
 * process result and not a guest pointer. */
