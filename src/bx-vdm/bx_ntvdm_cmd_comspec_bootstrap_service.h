...
#define BX_NTVDM_CMD_COMSPEC_BOOTSTRAP_MAX_BYTES BX_NTVDM_MULTI_WRITE_MAX_PAYLOAD
...
int bx_ntvdm_cmd_comspec_bootstrap_v1_complete_comspec(
    ...
    uint64_t byte_count, const bx_ntvdm_command_host_context_v1 *host_context,
