...
typedef enum bx_ntvdm_adapter_boot_file_diagnostic_v1 {
    ...
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_PROVIDER_INVALID,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_ARGUMENT,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_EVENT,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_CPU,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_WINDOW,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_CONTRACT,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_NAMESPACE,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_PATH,
    BX_NTVDM_ADAPTER_BOOT_FILE_DIAGNOSTIC_V1_TRANSACTION,
