...
enum bx_ntvdm_composition_install_stage_v1 {
    ...
    BX_NTVDM_COMPOSITION_INSTALL_STAGE_V1_DEM_PROFILE_CONSUMER,
    BX_NTVDM_COMPOSITION_INSTALL_STAGE_V1_DEM_CWD_ATTACH,
    BX_NTVDM_COMPOSITION_INSTALL_STAGE_V1_COMMAND_PROFILE_SESSION_INVALID,
    BX_NTVDM_COMPOSITION_INSTALL_STAGE_V1_COMMAND_PROFILE_ALREADY_BOUND,
    BX_NTVDM_COMPOSITION_INSTALL_STAGE_V1_COMMAND_PROFILE_CONSUMER,
    BX_NTVDM_COMPOSITION_INSTALL_STAGE_V1_COMMAND_CLI_STREAM_ADMISSION
};
