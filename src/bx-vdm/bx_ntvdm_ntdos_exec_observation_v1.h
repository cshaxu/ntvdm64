#ifndef BX_NTVDM_NTDOS_EXEC_OBSERVATION_V1_H
#define BX_NTVDM_NTDOS_EXEC_OBSERVATION_V1_H
 ...
 * sole owner.
 */
#define BX_NTVDM_NTDOS_EXEC_OBSERVATION_V1_MAGIC UINT32_C(0x4258454f)
#define BX_NTVDM_NTDOS_EXEC_OBSERVATION_V1_VERSION UINT32_C(1)
#define BX_NTVDM_NTDOS_EXEC_PDB_PREFIX_BYTES 50u
#define BX_NTVDM_NTDOS_EXEC_PDB_PARENT_OFFSET 22u
#define BX_NTVDM_NTDOS_EXEC_PDB_ENVIRONMENT_OFFSET 44u

struct bx_ntvdm_ntdos_exec_observation_v1 {
    uint32_t magic;
