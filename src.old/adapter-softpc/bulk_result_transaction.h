...
#define RUNTIME_BULK_RESULT_TRANSACTION_MAGIC 0x42584252u
#define RUNTIME_BULK_RESULT_TRANSACTION_VERSION 1u
#define RUNTIME_BULK_RESULT_TRANSACTION_MAX_PAYLOAD 65535u
...
typedef struct runtime_bulk_result_transaction {
...
} runtime_bulk_result_transaction;
