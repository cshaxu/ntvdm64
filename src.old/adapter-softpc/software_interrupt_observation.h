#ifndef RUNTIME_SOFTWARE_INTERRUPT_OBSERVATION_H
#define RUNTIME_SOFTWARE_INTERRUPT_OBSERVATION_H

#include <stdint.h>

#define RUNTIME_SOFTWARE_INTERRUPT_OBSERVATION_VERSION 1u
#define RUNTIME_SOFTWARE_INTERRUPT_OBSERVATION_CAPACITY_MAX 64u

struct runtime_software_interrupt_observation_record {
  uint32_t version;
  uint32_t cpu_id;
  uint64_t sequence;
  uint64_t rip;
