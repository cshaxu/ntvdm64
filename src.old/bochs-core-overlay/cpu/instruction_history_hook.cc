...
struct bochs_core_overlay_instruction_history {
...
{
#if defined(RUNTIME_ENABLE_MACHINE_INSTRUCTION_HISTORY) && RUNTIME_ENABLE_MACHINE_INSTRUCTION_HISTORY
  bochs_core_overlay_instruction_history record;
