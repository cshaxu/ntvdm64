...
CHAR	AppFullPathName[MAX_PATH + 1];
    ...
    /* DIVERGENCE(BOP-DIV-019): these historical locals belonged to removed ForceDos-era
	...
	/* DIVERGENCE(BOP-DIV-020): AppName is bounded by the original MAX_PATH buffer; make
	...
	/* DIVERGENCE(BOP-DIV-021): FullPathName is the original bounded MAX_PATH local. */
