...
Both builds emitted no former DEM DWORD-to-HANDLE or HANDLE-to-register-word truncation diagnostics. Remaining warnings are deliberately visible and outside this width-boundary closure.
