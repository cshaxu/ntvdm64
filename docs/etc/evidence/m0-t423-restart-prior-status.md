# T423 restart: retained prior status

Historical status retained during the owner-approved restart at 3821036ae.
This is not current admission or acceptance; CURRENT owns the new packet.
...
[T422 S1 WOW32 audit closure](../../etc/evidence/m0-t422-s1-wow32-audit-closure.md)
assigns the entire provider graph and S2's coupled contract.  It is a design
closure only; no WOW16 application acceptance is carried forward as passed.
...
unresolved in [TODO](../../states/TODO.md), as approved by the owner; it is not a pass
