...
`tools/Invoke-T198S16BootNamespaceVdmX64Probe.ps1` source-built, linked, and ran under MSVC x64 `/MT` with `artifacts/build/t199-s7-command-facade-r2`; its JSON record reports zero link and run exits. No bx-core, bx-mantle, Bochs product, OpenNT runtime, or guest trace entered the fixture.
