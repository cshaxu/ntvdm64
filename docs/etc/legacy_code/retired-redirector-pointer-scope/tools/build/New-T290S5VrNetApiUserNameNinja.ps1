...
$build = Join-Path $root ("build/M0-T290/S5/vrnetapi-user-name-{0}" -f $Architecture)
...
rule cc
  ...
  description = CC `$in
rule link
  command = cmd /c "`$environment link /nologo /OPT:REF /FORCE:UNRESOLVED /out:`$out `$in netapi32.lib"
...
build obj/fixture.obj: cc `$root/tests/mvdm-host/vdmredir/t290_s5_vrnetapi_user_name_fixture.c
build bin/t290-s5-vrnetapi-user-name-fixture.exe: link obj/vrnetapi.obj obj/pointer_scope.obj obj/mapping.obj obj/lease.obj obj/session.obj obj/fixture.obj
default bin/t290-s5-vrnetapi-user-name-fixture.exe
"@
...
Write-Host "Generated T290 S5 $Architecture original VrNetApi user-name graph: $build"
