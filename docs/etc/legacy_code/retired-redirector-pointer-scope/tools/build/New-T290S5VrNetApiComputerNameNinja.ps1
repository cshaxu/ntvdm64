...
$build = Join-Path $root ("build/M0-T290/S5/vrnetapi-computer-name-{0}" -f $Architecture)
...
build obj/fixture.obj: cc `$root/tests/mvdm-host/vdmredir/t290_s5_vrnetapi_computer_name_fixture.c
build bin/t290-s5-vrnetapi-computer-name-fixture.exe: link obj/vrnetapi.obj obj/pointer_scope.obj obj/mapping.obj obj/lease.obj obj/session.obj obj/fixture.obj
default bin/t290-s5-vrnetapi-computer-name-fixture.exe
"@
...
Write-Host "Generated T290 S5 $Architecture original VrNetApi computer-name graph: $build"
