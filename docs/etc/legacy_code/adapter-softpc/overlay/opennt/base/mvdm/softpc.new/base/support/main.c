...
/* Default-disabled post-host_applInit trace checkpoints; no startup behavior changes. */
#ifdef NTDOS64_HOST_MAIN_TRACE
extern void ntdos64_host_applinit_trace_checkpoint(int stage);
#define NTDOS64_HOST_MAIN_TRACE_STAGE(stage) \
    ntdos64_host_applinit_trace_checkpoint(stage)
#else
#define NTDOS64_HOST_MAIN_TRACE_STAGE(stage) ((void)0)
#endif
 ...
 ***********************************************************************/
  ...
  NTDOS64_HOST_MAIN_TRACE_STAGE(60);
   ...
   */
  NTDOS64_HOST_MAIN_TRACE_STAGE(61);
  gfi_init();
  NTDOS64_HOST_MAIN_TRACE_STAGE(62);
...
#endif
  NTDOS64_HOST_MAIN_TRACE_STAGE(63);
 ...
 *------------------------*/
  ...
  config();
  NTDOS64_HOST_MAIN_TRACE_STAGE(64);
 ...
 *----------------------*/
  ...
  cpu_init();
  NTDOS64_HOST_MAIN_TRACE_STAGE(65);
