...
/* Default-disabled host_applInit trace checkpoints; no UI behavior changes. */
#ifdef NTDOS64_HOST_APPLINIT_TRACE
extern void ntdos64_host_applinit_trace_checkpoint(int stage);
#define NTDOS64_HOST_UI_TRACE_STAGE(stage) \
    ntdos64_host_applinit_trace_checkpoint(stage)
#else
#define NTDOS64_HOST_UI_TRACE_STAGE(stage) ((void)0)
#endif
...
int init_host_uis()
{
    NTDOS64_HOST_UI_TRACE_STAGE(20);
    InitScreenDesc();
    NTDOS64_HOST_UI_TRACE_STAGE(28);

    NTDOS64_HOST_UI_TRACE_STAGE(36);
    if(CreateDisplayPalette())
    {
	SelectPalette(sc.DispDC,sc.ColPalette,0);/* Select foreground palette */
    }
    NTDOS64_HOST_UI_TRACE_STAGE(29);
...
SECURITY_ATTRIBUTES sa;
    ...
    NTDOS64_HOST_UI_TRACE_STAGE(21);
	...
	DisplayErrorTerm(EHS_FUNC_FAILED,GetLastError(),__FILE__,__LINE__);
    NTDOS64_HOST_UI_TRACE_STAGE(22);
    ...
    NTDOS64_HOST_UI_TRACE_STAGE(23);
    ...
    NTDOS64_HOST_UI_TRACE_STAGE(24);
    ...
    NTDOS64_HOST_UI_TRACE_STAGE(25);
    SetupConsoleMode();
    NTDOS64_HOST_UI_TRACE_STAGE(26);
	...
	NTDOS64_HOST_UI_TRACE_STAGE(27);
...
BOOL CreateDisplayPalette(void)
{
   ...
   NTDOS64_HOST_UI_TRACE_STAGE(35);
   LogPalette = (NPLOGPALETTE) LocalAlloc(LMEM_FIXED,
    ...
    NTDOS64_HOST_UI_TRACE_STAGE(32);
