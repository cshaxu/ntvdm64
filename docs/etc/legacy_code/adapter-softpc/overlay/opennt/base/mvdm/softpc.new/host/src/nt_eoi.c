...
{
/* The enclosing host_applInit trace observes the native RTL boundary only. */
#ifdef NTDOS64_HOST_APPLINIT_TRACE
    extern void ntdos64_host_applinit_trace_checkpoint(int stage);
    ntdos64_host_applinit_trace_checkpoint(15);
#endif
    RtlInitializeCriticalSection(&IcaLock);
#ifdef NTDOS64_HOST_APPLINIT_TRACE
    ntdos64_host_applinit_trace_checkpoint(16);
#endif
