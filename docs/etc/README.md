...
| [T403 x86 mirror-retirement inventory](evidence/m0-t403-s1-x86-mirror-retirement-inventory-001.md) | M0 T403 S1 | Active source-comparison dispositions and selected-x86 build evidence. | Supersede at T403 closure with its immutable history record. |
