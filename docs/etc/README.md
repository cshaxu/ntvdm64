...
| [Documentation inventory](operations/document-inventory.md) | Documentation governance | Generated content inventory and topology classification for current governed records. | Regenerate on every governed-document change. |
