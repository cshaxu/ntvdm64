...
| [T412 S5 WOW/idle lifecycle](evidence/m0-t412-s5-wow-idle-lifecycle.md) | M0 T412 S5 | Original ExitVDM recovery, empty-broker grace, and authenticated same-Console identity binding; eligible worker retirement remains open. | Retain through T412 closure. |
