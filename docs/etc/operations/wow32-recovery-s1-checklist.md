...
| A02 | In progress | Every selected file, function/dispatch entry, export, resource, dynamic lookup and indirect callback assigned and classified. | All 1,786 dispatch rows now have source disposition and all 668 selected thunks have bodies; the original resource and all original exports are now formal-link checked, and dynamic exports are host-verified. Complete function/callback receiver allocation remains. |
