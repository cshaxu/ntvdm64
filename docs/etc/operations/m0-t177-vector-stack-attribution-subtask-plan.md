...
| S3 | Decide whether the exact existing combined native-POST/machine-composition form merits one build and one bounded observation, or close T177 with the attribution. | Active in Status. |
