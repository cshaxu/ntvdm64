...
| S | Scope | Disposition |
| --- | --- | --- |
| S1 | Source/IVT/vector ownership map from the reached post-COMMAND state to the first unproven transfer toward `0000:019d`. | Active in Status. |
| S2 | Cross-check the map against Bochs native real-mode delivery and classify excluded adapter/device ownership. | Deferred. |
