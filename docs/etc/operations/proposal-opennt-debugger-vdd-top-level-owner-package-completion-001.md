...
Recover the OpenNT debugger, VDD and top-level notification/service routes
...
1. **S1 — audit:** map debugger selectors, VDD dispatch, notifications,
   idle/scheduler hooks and top-level `nt_bop.c` routes to original source and
