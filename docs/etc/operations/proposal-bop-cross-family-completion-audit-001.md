...
- Complete declared-package regressions, including explicit unavailable/deferred outcomes.
...
provider route, compatibility disposition and whole-package regression for
...
compositions or broad guest execution exist.
