...
| Migration conclusion | `retain-facade`, `retain-generic-mechanics`, `retain-guest-source`, `not-applicable-guest`, `migrate-facade`, `replace-with-mirror`, `delete`, or `deferred-owner-package`. |
