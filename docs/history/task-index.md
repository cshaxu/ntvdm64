...
| `M0 T231` | Closed as OpenNT COMMAND `54:00..10` code-complete/v2 product-route closure: all 17 owner slots have local coverage, v1 product routes are retired, and the shared DEM/COMMAND formal Ninja graph succeeds. Native `54:xx` reachability remains a machine/BIOS integration concern. | [m0-t231-closure-20260820.md](m0-t231-closure-20260820.md) |
| `M0 T268` | Closed current non-mirror naming convergence: retired local project/component/generation labels are removed from active production/build/governance surfaces, with only classified historical or immutable external spellings retained. | [m0-t268-closure-20260825.md](m0-t268-closure-20260825.md) |
| `M0 T269` | Closed OpenNT-host mirror/overlay convergence: every retained host unit has source identity and a compliant disposition; private bindings remain private; the PIF parser's exact source is assigned to its sole COMMAND/BOP composition owner. | [m0-t269-closure-20260825.md](m0-t269-closure-20260825.md) |
| `M0 T271` | Closed by owner-directed exit-criterion revision after original DEM, COMMAND and XMS package recovery plus whole-root mirror/owner audit. Remaining cross-component headers, app-held BOP composition and overlay-test privacy are explicitly deferred, not claimed complete. | [m0-t271-closure-20260825.md](m0-t271-closure-20260825.md) |
...
| M0 T96 S3 | Closed DEM provider plane: every callable service has an original component/disposition, all admitted slices use common ingress/selection plus the unified DEM plane, and raw-media semantics remain deferred. Legacy runtime migration remains S8. | [m0-t96-s3-closure-20260811.md](m0-t96-s3-closure-20260811.md) |
