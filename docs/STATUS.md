...
| M0 T96 S3 | Admitted in Ordinary Mode; unified DEM plane classifies all 73 callable services by original component and disposition; source-contract slices remain bounded and runtime migration remains deferred to S8. |
