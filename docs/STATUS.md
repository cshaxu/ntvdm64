...
**S3 P8 closed:** [original callback source binding](etc/evidence/m0-t335-s3-p8-wow-callback-source-binding-001.md) compiles the selected `wcall16.c` body on x86/x64 with original declaration and CCPU40 stack selection. The linked source-shaped recursive callback transaction remains active S3 work.
