...
| P2 | Reconcile T271's residual BOP/package recovery evidence with the canonical `opennt-mvdm-host` rebootstrap: five compatibility headers, app-held selector/service composition, and test-to-overlay privacy. | During rebootstrap, classify each residual as an original MVDM package unit, app composition, session/broker state, or a declared adapter contract; use `m0-t271-closure-20260825.md` and its P10 ledger as historical evidence, not as a source-layout precedent. |
