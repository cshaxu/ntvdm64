...
`BOP-DEPENDENCY-117` and the [T254 S1 admission map](../../artifacts/documentation-archive/20260910/etc/evidence/m0-t254-s1-dpmi-profile-source-abi-admission-map-001.md)
