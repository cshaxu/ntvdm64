...
| Asset Needs | Accepted OpenNT source, immutable guest media, existing formal x86 product, `build/M0-T412/S5` for generated/build/test outputs, and `O:\winnt\logs` for real-package observations. |
...
into S4. S5 is the only active packet under the existing whole-T approval. S3
