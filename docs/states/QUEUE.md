...
| --- | --- | --- |
| 1 | Mirror, overlay and adapter footprint cleanup — remove obsolete startup carriers, redundant private wrappers and completed diagnostic seams; preserve ownership and quantify net reductions separately from relocation. | [Proposal](../proposals/proposal-mirror-overlay-footprint-cleanup-001.md) |
