...
**Dependency-first activation rule:** after the source-diff audit, execute the earliest runtime candidate's frozen
...
| --- | --- | --- |
| 1 | OpenNT MVDM and non-MVDM source-diff audit — include mirror, overlay and autonomous replacements across COMMAND/EDIT/WOW paths; count functional units, files and added/deleted lines separately and produce an original-owner restoration ledger. Read-only; no repair admission. | [Proposal](../proposals/proposal-opennt-source-diff-audit-001.md) |
