...
| --- | --- | --- |
| 1 | WOW32 production completion after initial WINMINE milestone — inherit all research, working code and unresolved contracts; complete dependency-ordered production packages with checked-in tests and finish WRITE, WINMINE and SOL acceptance. | [Proposal](../proposals/proposal-wow32-production-completion-002.md) |
