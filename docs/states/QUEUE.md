...
| --- | --- | --- |
| 1 | Original physical-memory mapping contract audit and restoration — resolve U02 source ownership and alias, overlap, backing and unmap semantics, then restore proved original behavior through finite bindings before DPMI/XMS recovery. No generic identity manager or kernel-shell revival. | [Proposal](../proposals/proposal-physical-memory-mapping-restoration-001.md) |
| 2 | Original DPMI and XMS contract restoration — recover D36-D37 memory ownership and callbacks together, then D35 mode-transition frames through bounded CCPU state bindings. Resolve reached U04/U07 boundaries without importing a kernel shell or changing CPU instruction semantics; no broker prerequisite. | [Proposal](../proposals/proposal-dpmi-xms-contract-restoration-001.md) |
| 3 | Original RTL and character-conversion restoration — recover D11-D16 and D26 through original environment, status, arithmetic, fill and encoding owners with finite modern bindings; no broker prerequisite or new generic runtime replacement. | [Proposal](../proposals/proposal-rtl-character-conversion-restoration-001.md) |
| 4 | Original DOS file-service restoration — restore original DEM/VDD handle ownership and fast-read semantics, replacing duplicated shadow and overlay policy through bounded guest-memory and user-mode bindings. Independent of broker implementation; preserves the current CLI and worker profile. | [Proposal](../proposals/proposal-dos-file-service-restoration-001.md) |
