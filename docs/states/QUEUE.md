...
| --- | --- | --- |
| 1 | VDMREDIR/WOW32 DLL compilation-boundary reorganization — after the active VDMREDIR package accepts, make both independently loaded DLL targets explicit while keeping original sources in the canonical MVDM mirror and worker-local state solely in `ntvdm.exe`. | [Proposal](../proposals/proposal-vdmredir-wow32-dll-component-boundary-reorganization-001.md) |
| 2 | WOW32 complete runtime recovery — inherit all prior USER/WOW32 research, retained partial implementation and immutable WOW16/WRITE acceptance; finish source-backed client objects, task/window/message lifecycles, resources, services and full production validation. | [Proposal](../proposals/proposal-wow32-complete-runtime-recovery-001.md) |
