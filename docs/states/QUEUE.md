...
| 2 | Selective NTVDMx64 source-correction recovery — prove and repair remaining CPU/device/ABI, rendering and DPMI lifecycle defects; account for existing equivalent fixes and reject unsupported optimization/hack imports. | [Proposal](../proposals/proposal-ntvdmx64-source-corrections-001.md) |
