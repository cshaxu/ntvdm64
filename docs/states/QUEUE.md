...
| --- | --- | --- |
| 1 | Component-boundary normalization and legacy broker retirement — delete the proved-unused in-process broker plane, partition adapter ownership by original caller and extract only proved private adapter state from session without moving modern mechanics into mirrors. | [Proposal](../proposals/proposal-component-boundary-normalization-001.md) |
