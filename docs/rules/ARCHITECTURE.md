...
11. A compatibility facade may not recreate an unbounded historical product
    shell behind a familiar name. A `bx-vdm`-owned, bounded mapping lease may
