...
The nineteen-component architecture separates canonical original MVDM host
runtime, support-library and standalone-tool mirrors:
`opennt-mvdm-host`, `opennt-mvdm-support` and `opennt-mvdm-tools`. It also
