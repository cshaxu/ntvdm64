...
only by its existing, narrow source-closure brief in `STATUS.md`. It is not
expanded to perform the new perimeter work. The first **new** candidate after
that bounded packet closes is item 1 below.
