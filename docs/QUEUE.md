...
| --- | --- | --- | --- |
| 1 | Selector-blind real-mode guest execution continuity | Recover the machine-owned CPU/interrupt/return continuity first reached after source-built NTDOS `$Exec → 50:36`; it may not identify BOP/DOS/PSP semantics in bx-core or bx-mantle. | [Machine-continuity proposal](etc/operations/proposal-selector-blind-realmode-continuity-001.md): source/ABI map, bounded replay, minimal mechanics and native checkpoint. |
