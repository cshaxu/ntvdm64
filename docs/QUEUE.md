...
| 2 | Original XMS owner package | Recover `xms.486` through the source-shaped A20/RAM/IVT/UMB mechanical seam. | [Wave 4](etc/operations/mvdm-package-recovery-wave-plan-001.md#wave-4-xms). |
| 3 | Original VDM monitor substrate | Recover `sim16`, `sim32`, `v86` and `ieuvddex` through the complete same-shaped monitor adapter. | [Wave 5](etc/operations/mvdm-package-recovery-wave-plan-001.md#wave-5-vdm-monitor-substrate). |
| 4 | Original DPMI owner packages | Recover `dpmi` and `dpmi32` after their complete protected-machine dependency profile closes. | [Wave 6](etc/operations/mvdm-package-recovery-wave-plan-001.md#wave-6-dpmi). |
| 5 | Original Redirector and brokered COMMAND extensions | Recover `vdmredir` and only its source-proven brokered COMMAND dependencies. | [Wave 7](etc/operations/mvdm-package-recovery-wave-plan-001.md#wave-7-redirector-and-brokered-command-extensions). |
| 6 | Original WOW owner packages | Recover `wow32` and `fax` after their monitor, COMMAND, Redirector and adapter-wow rows close. | [Wave 8](etc/operations/mvdm-package-recovery-wave-plan-001.md#wave-8-wow). |
| 7 | Original VDD and debugger packages | Recover `vdd`, `bde`, `dbg`, `vdmdbg` and `vdmexts` after required monitor and machine callback rows close. | [Wave 9](etc/operations/mvdm-package-recovery-wave-plan-001.md#wave-9-vdd-and-debugger-products). |
| 8 | MVDM platform-ABI canonical union | Replace edition-named parallel ABI source roots with one selected OpenNT public/private declaration tree under `mvdm-platform-abi`; record every merged, one-sided and conflicting header selection with source/hash/rejection evidence, then update all include/build manifests. | [Platform-ABI canonical-union proposal](etc/operations/proposal-mvdm-platform-abi-canonical-union-001.md). |
