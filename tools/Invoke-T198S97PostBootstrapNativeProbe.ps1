...
$inner = Join-Path $repository 'tools\Invoke-T198S94SourceBuiltNormalReturnNativeProbe.ps1'
...
[ordered]@{
    ...
    reusedHarness = 'tools/Invoke-T198S94SourceBuiltNormalReturnNativeProbe.ps1'
    inputContract = 'S93 exact source-built COMMAND.COM/SHARE.EXE and v7 profile'
    currentCompositionManifest = 'tools/t198-s50-bx-vdm-composition-manifest.json'
    runs = $record.runs
