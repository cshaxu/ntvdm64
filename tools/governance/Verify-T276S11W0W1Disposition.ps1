...
Write-Output "T276 S11 W0/W1 disposition verification passed: $($fileLedger.Count) files, $($familyLedger.Count) interface-family rows, $($callLedger.Count) lexical calls."
