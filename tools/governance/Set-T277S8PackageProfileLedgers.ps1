...
$cycles = @([pscustomobject]@{
    ...
    required_resolution = 'co-link the reached DOS/DEM/COMMAND and SoftPC host-control units within one opennt-mvdm-host composition unit, or introduce a one-way source-shaped facade; never create cyclic static libraries'
