...
$required = @(
    'src/adapter-win32/include/vdm.h',
    'src/adapter-win32/include/winbasep.h',
    'src/adapter-win32/source/vdm_control.c',
    'tests/adapter-win32/vdm_control_fixture.c',
...
$source = Get-Content -LiteralPath (Join-Path $root 'src/adapter-win32/source/vdm_control.c') -Raw
