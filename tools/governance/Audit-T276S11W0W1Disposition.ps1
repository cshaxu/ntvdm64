...
$sourceFamilies = @(
    @{ path='oemuni/file.c'; family='public Win32 file/path/drive APIs'; symbols='CreateDirectoryW;CreateFileW;DeleteFileW;FindFirstFileW;FindNextFileW;FindClose;GetCurrentDirectoryW;GetDiskFreeSpaceW;GetDriveTypeW;GetFileAttributesW;GetFullPathNameW;GetVolumeInformationW;MoveFileExW;MoveFileW;RemoveDirectoryW;RemoveFontResourceW;SetCurrentDirectoryW;SetFileAttributesW;SetLastError;OutputDebugStringA'; owner='adapter-mvdm-host-out/win32'; state='adapter-binding-review'; reason='original OEM wrappers preserve algorithm; public calls are available but original OEM/ANSI/NT error ABI must be retained' },
    @{ path='oemuni/file.c'; family='NT RTL/PEB/TEB conversion and heap APIs'; symbols='NtCurrentPeb;NtCurrentTeb;RtlAcquirePebLock;RtlAllocateHeap;RtlEqualUnicodeString;RtlFreeAnsiString;RtlFreeHeap;RtlFreeOemString;RtlFreeUnicodeString;RtlGetCurrentDirectory_U;RtlGetFullPathName_U;RtlInitAnsiString;RtlInitString;RtlInitUnicodeString;RtlOemStringToUnicodeString;RtlProcessHeap;RtlReleasePebLock;RtlSetCurrentDirectory_U;RtlUnicodeStringToAnsiString;RtlUnicodeStringToOemString'; owner='adapter-mvdm-host-out/win32'; state='adapter-binding-review'; reason='historical NTDLL-facing ABI requires same-shaped compatibility assessment before source enablement' },
    @{ path='oemuni/process.c'; family='public Win32 process/environment/path APIs'; symbols='CreateProcessW;ExpandEnvironmentStrings;GetEnvironmentVariableA;GetShortPathNameW;GetSystemDirectoryW;GetTempFileNameW;GetTempPathW;GetWindowsDirectoryW;SearchPathW;SetEnvironmentVariableA;SetLastError'; owner='adapter-mvdm-host-out/win32'; state='adapter-binding-review'; reason='public APIs exist; original OEM conversion and process semantics must remain in mirror source' },
    @{ path='oemuni/process.c'; family='NT RTL/TEB conversion and heap APIs'; symbols='NtCurrentTeb;RtlAllocateHeap;RtlAnsiStringToUnicodeString;RtlFreeAnsiString;RtlFreeHeap;RtlFreeUnicodeString;RtlInitString;RtlInitUnicodeString;RtlOemStringToUnicodeSize;RtlOemStringToUnicodeString;RtlProcessHeap;RtlUnicodeStringToAnsiString;RtlUnicodeStringToOemString'; owner='adapter-mvdm-host-out/win32'; state='adapter-binding-review'; reason='historical NTDLL-facing ABI requires same-shaped compatibility assessment before source enablement' },
    ...
    @{ path='suballoc/suballoc.c'; family='CRT allocator and public diagnostic surface'; symbols='malloc;OutputDebugString;RtlZeroMemory;sprintf'; owner='adapter-mvdm-host-out/win32-and-toolchain'; state='adapter-binding-review'; reason='original library member; CRT allocation ABI and optional diagnostic binding require explicit x86/x64 review' },
