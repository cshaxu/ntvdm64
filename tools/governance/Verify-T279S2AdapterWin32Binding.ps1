...
$audit = Get-Content -LiteralPath (Join-Path $root 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t279-s2-adapter-mvdm-host-out/win32-binding-audit-001.md') -Raw
