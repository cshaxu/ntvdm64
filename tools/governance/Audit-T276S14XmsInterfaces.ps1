...
$families = @(
    [pscustomobject][ordered]@{ interface_id='XMS-IF-01'; interface_family='XMS service dispatch ABI'; source_paths='xms.486/xms.h; xms.486/xmsdisp.c'; owner='adapter-mvdm-host-in; adapter-softpc'; contract='Original XMS dispatch table and unsupported-service result remain in source; adapter-mvdm-host-in carries mechanics only.'; disposition='existing adapter boundary prerequisite' },
