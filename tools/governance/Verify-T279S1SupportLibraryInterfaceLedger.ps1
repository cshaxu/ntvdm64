...
$oemSources = Get-Content (Join-Path $root 'src/opennt-mvdm-support/oemuni/sources') -Raw
$suballocSources = Get-Content (Join-Path $root 'src/opennt-mvdm-support/suballoc/sources') -Raw
