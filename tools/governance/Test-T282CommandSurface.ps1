...
$source = @(Import-Csv -LiteralPath (Join-Path $root 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t282-s1-command-source-disposition-ledger.tsv') -Delimiter "`t")
$service = @(Import-Csv -LiteralPath (Join-Path $root 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t282-s1-command-service-disposition-ledger.tsv') -Delimiter "`t")
