...
$map = @{
    ...
    'adapter-win32-host-capability' = @('adapter-prerequisite', 'adapter-win32 same-shaped host capability group')
    ...
    'opennt-bop-dispatch' = @('adapter-prerequisite', 'adapter-bop/adapter-softpc plus complete owner provider groups')
