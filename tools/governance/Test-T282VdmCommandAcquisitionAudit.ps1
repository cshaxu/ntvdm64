...
$path = Join-Path (Resolve-Path -LiteralPath $RepositoryRoot).Path 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t282-s5-vdm-command-acquisition-ledger.tsv'
