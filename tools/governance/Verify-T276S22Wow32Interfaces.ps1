...
$path = Join-Path (Resolve-Path $RepositoryRoot).Path 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t276-s22-wow32-interface-family-ledger.tsv'
