...
$plan = Join-Path $root 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t280-s7-dem-shared-abi-design-plan-001.md'
$ledger = Join-Path $root 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t280-s7-dem-shared-abi-ledger.tsv'
$evidence = Join-Path $root 'artifacts/documentation-archive/20260910/etc/operations/ledgers/m0-t280-s7-dem-shared-abi-evidence-001.md'
