...
function Get-Contract {
    ...
    switch ($Group) {
        ...
        'cross-owner-launch-configuration' { return @('app; session; adapter-win32; adapter-softpc; adapter-vdm-monitor; opennt-mvdm-host owner packages', 'original launch/configuration composition crosses PIF, console, host environment, monitor and machine setup; retain exact mirror and do not classify it as a standalone Win32 provider', 'composition-prerequisite review') }
