...
$sources = @('src\bx-mantle\bx_ntvdm_cancellation_controller_v1.cc', 'src\bx-mantle\bx_ntvdm_engine_contract_v1.c', 'src\bx-mantle\bx_ntvdm_engine_run_v1.c', 'tests\bx-mantle\t212_s5_engine_cancellation_test.c') | ForEach-Object { Join-Path $root $_ }
