...
$cflags = '/nologo /std:c11 /MT /W4 /showIncludes /FI ' + $root + '/src/opennt-abi/host-compat/include/nt.h /FI ' + $root + '/src/ntvdm-exe/softpc/include/error_abi.h /I ' + $root + '/src/opennt-abi/host-compat/include /I ' + $root + '/src/ntvdm-exe/softpc/include /I ' + $root + '/src/mvdm-host/softpc.new/host/inc /I ' + $root + '/src/mvdm-host/softpc.new/base/inc'
$content = @"
