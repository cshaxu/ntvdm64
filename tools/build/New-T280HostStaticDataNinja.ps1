...
$cflags = '/nologo /std:c11 /MT /W4 /showIncludes /FI ' + $root + '/src/adapter-mvdm-host-out/win32/include/nt.h /FI ' + $root + '/src/adapter-mvdm-host-out/softpc/include/error_abi.h /I ' + $root + '/src/adapter-mvdm-host-out/win32/include /I ' + $root + '/src/adapter-mvdm-host-out/softpc/include /I ' + $root + '/src/mvdm-host/softpc.new/host/inc /I ' + $root + '/src/mvdm-host/softpc.new/base/inc'
$content = @"
