...
$includes = @('src', 'src/opennt-abi/host-compat/include',
    ...
    'src/mvdm-support/inc', 'src/mvdm-host/inc', 'src/mvdm-host/dos/command', 'src/ntvdm/session',
...
build obj/mvdm_command_redirection.obj: cc `$root/src/ntvdm/redir/mvdm_command_redirection.c
