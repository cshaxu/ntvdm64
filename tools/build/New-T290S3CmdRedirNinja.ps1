...
$includes = @('src', 'src/adapter-mvdm-host-out/win32/include',
    ...
    'src/mvdm-support/inc', 'src/mvdm-host/inc', 'src/mvdm-host/dos/command', 'src/session',
...
build obj/mvdm_command_redirection.obj: cc `$root/src/adapter-mvdm-host-out/redir/mvdm_command_redirection.c
