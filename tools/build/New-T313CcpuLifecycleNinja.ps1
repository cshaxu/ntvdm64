...
$adapterSources = @('src/adapter-mvdm-host-out/softpc/mvdm_softpc_execution.c', 'src/adapter-mvdm-host-out/softpc/mvdm_softpc_termination.c', 'src/adapter-mvdm-host-out/softpc/mvdm_softpc_effective_address.c', 'src/adapter-mvdm-host-out/softpc/mvdm_softpc_guest_memory.c', 'src/adapter-mvdm-host-out/softpc/mvdm_softpc_physical_mapping.c', 'src/adapter-mvdm-host-out/softpc/mvdm_a20.c', 'src/session/session.c', 'src/session/guest_memory_lease.c')
...
$graph.Add('build ccpu-lifecycle.exe: link ' + (($testObjects + $controllerObjects + $supportObjects + @($patchObject, 'original-ccpu40.lib', 'original-host-lifecycle.lib', 'lifecycle-adapter.lib')) -join ' '))
