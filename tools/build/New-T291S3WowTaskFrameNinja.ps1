...
$cflags = '/nologo /std:c11 /MT /W4 /WX /showIncludes /I ' + $root + '/src /I ' + $root + '/src/session /I ' + $root + '/src/ntvdm-exe/monitor/include'
$content = @"
...
build obj/fixture.obj: cc `$root/tests/ntvdm/monitor/t291_s3_wow_task_frame_fixture.c
