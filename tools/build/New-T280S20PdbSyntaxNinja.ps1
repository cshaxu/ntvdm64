...
$cflags = '/nologo /std:c11 /MT /W4 /DWIN_32 /DDEVL=1 /Zs /showIncludes /I ' + $root + '/src /I ' + $root + '/src/adapter-mvdm-host-out/softpc/include /I ' + $root + '/src/adapter-mvdm-host-out/monitor/include /I ' + $root + '/src/adapter-mvdm-host-out/win32/include /I ' + $root + '/src/mvdm-host/dos/dem /I ' + $root + '/src/mvdm-support/inc /I ' + $root + '/src/mvdm-platform-abi/source/public/sdk/inc /I ' + $root + '/src/mvdm-platform-abi/source/public/ddk/inc /I ' + $root + '/src/mvdm-host/softpc.new/base/inc /I ' + $root + '/src/mvdm-host/softpc.new/host/inc'
$content = @"
...
build demfile: syntax `$root/src/mvdm-host/dos/dem/demfile.c
build nt_fdisk: syntax `$root/src/mvdm-host/softpc.new/host/src/nt_fdisk.c
build nt_rflop: syntax `$root/src/mvdm-host/softpc.new/host/src/nt_rflop.c
