...
$cflags = '/nologo /std:c11 /MT /W4 /showIncludes /DWIN_32 /DDEVL /DNTVDM ' +
    ...
    '/I ' + $root + '/src/opennt-platform-abi/source/opennt/public/internal/windows/inc ' +
...
build obj/command_initialization_fixture.obj: cc `$root/tests/opennt-mvdm-host/command_initialization_fixture.c
build obj/cmd.obj: cc `$root/src/opennt-mvdm-host/dos/command/cmd.c
build obj/cmddata.obj: cc `$root/src/opennt-mvdm-host/dos/command/cmddata.c
