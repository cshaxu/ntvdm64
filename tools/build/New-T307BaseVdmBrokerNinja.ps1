...
build base_vdm_broker_fixture.exe: link obj/fixture.obj obj/base_vdm_client.obj obj/base_vdm_local.obj obj/launch_declaration.obj obj/thread_start_compat.obj obj/session.obj obj/mapping_manager.obj obj/guest_memory_lease.obj
build test: run base_vdm_broker_fixture.exe
default base_vdm_broker_fixture.exe
"@
...
Write-Host "Wrote T307 $Architecture Base VDM Ninja graph: $build/build.ninja"
