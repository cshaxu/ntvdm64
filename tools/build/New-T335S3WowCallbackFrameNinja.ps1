...
$cflags = '/nologo /std:c11 /MT /W4 /WX /showIncludes /I ' + $root + '/src /I ' + $root + '/src/session /I ' + $root + '/src/adapter-mvdm-host-out/wow/include'
$content = @"
...
build bin/t335-s3-wow-callback-frame-fixture.exe: link obj/mapping_manager.obj obj/guest_memory_lease.obj obj/session.obj obj/wow_callback_frame_lease.obj obj/fixture.obj
