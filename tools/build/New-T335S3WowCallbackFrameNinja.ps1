...
$cflags = '/nologo /std:c11 /MT /W4 /WX /showIncludes /I ' + $root + '/src /I ' + $root + '/src/session /I ' + $root + '/src/ntvdm/wow/include /I ' + $root + '/src/ntvdm/softpc/include /I ' + $root + '/src/opennt-abi/host-compat/include /I ' + $root + '/src/opennt-host/public/sdk/inc'
$content = @"
...
build obj/mvdm_softpc_guest_memory.obj: cc `$root/src/ntvdm/softpc/mvdm_softpc_guest_memory.c
build obj/wow_callback_frame_lease.obj: cc `$root/src/ntvdm/wow/wow_callback_frame_lease.c
