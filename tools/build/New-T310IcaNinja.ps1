...
$cflags = '/nologo /TC /c /MT /Gy /W4 /showIncludes /DWIN32 /DWINNT /DNTVDM /DCPU_30_STYLE /DCPU_40_STYLE /DNEW_CPU /DCCPU /DSPC386 /DSIM32 /DANSI /DPROD /FI "' + $nt + '" /FI "' + $ntexapi + '" ' + ($includes -join ' ')
...
$graph.Add('build softpc-ica-lock-fixture.exe: link obj/nt_eoi.obj obj/softpc_ica_lock_fixture.obj')
