...
build obj/ntioapi_facade.obj: cc `$root/src/adapter-mvdm-host-out/win32/source/ntioapi_facade.c
build obj/ntioapi_fixture.obj: cc `$root/tests/adapter-mvdm-host-out/win32/t280_s11_ntioapi_facade_fixture.c
