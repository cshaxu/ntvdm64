...
$cflags = '/nologo /std:c11 /MT /W4 /showIncludes /I ' + $root + '/src/adapter-win32/include /I ' + $root + '/src/session'
$content = @"
...
build obj/vdm_control_fixture.obj: cc `$root/tests/adapter-win32/vdm_control_fixture.c
build obj/vdm_control.obj: cc `$root/src/adapter-win32/source/vdm_control.c
