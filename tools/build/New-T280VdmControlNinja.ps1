...
$cflags = '/nologo /std:c11 /MT /W4 /showIncludes /I ' + $root + '/src/ntvdm-exe/monitor/include /I ' + $root + '/src/opennt-abi/host-compat/include /I ' + $root + '/src/opennt-host/public/sdk/inc /I ' + $root + '/src/opennt-abi/source/public/sdk/inc /I ' + $root + '/src/opennt-abi/source/public/internal/base/inc /I ' + $root + '/src/session'
$content = @"
...
build obj/vdm_control.obj: cc `$root/src/ntvdm-exe/monitor/source/vdm_control.c
