...
$build = Join-Path $root ("build/M0-T291/S3/wow-callback-transaction-{0}" -f $Architecture)
...
Write-Host "Generated T291 S3 $Architecture WOW callback-transaction graph: $build"
