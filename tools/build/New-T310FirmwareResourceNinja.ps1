...
$archDefine = if ($Architecture -eq 'x86') { ' /Di386' } else { '' }
$sources = @(
...
$graph.Add('cflags = /nologo /TC /c /MT /W4 /showIncludes' + $archDefine +
...
$graph.Add('build softpc-firmware-resource-fixture.exe: link ' + ($objects -join ' '))
