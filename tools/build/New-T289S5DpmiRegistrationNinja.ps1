...
$c = @('src/session/mapping_manager.c', 'src/session/guest_memory_lease.c', 'src/session/session.c',
    ...
    'src/adapter-mvdm-host-out/softpc/mvdm_command_registers.c', 'src/adapter-mvdm-host-out/softpc/mvdm_host_identity.c', 'src/adapter-mvdm-host-out/softpc/mvdm_protected_frame_transaction.c', 'src/adapter-mvdm-host-out/softpc/mvdm_protected_span.c',
