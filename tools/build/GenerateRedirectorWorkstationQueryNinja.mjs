...
const ninja = [
  ...
  "",
  "build obj/vrnetapi.obj: cc $root/src/mvdm/vdmredir/vrnetapi.c",
  "build obj/vrremote.obj: cc $root/src/mvdm/vdmredir/vrremote.c",
  ...
  "build obj/lease.obj: cc $root/src/ntvdm-exe/session/guest_memory_lease.c",
