...
$unexp = Join-Path $root 'artifacts\build\current\t113-unexp-compile-projection-r3\CMakeFiles\runner-opennt-system-provider-objects.dir\base\mvdm\softpc.new\base\system\unexp_nt.c.obj'
