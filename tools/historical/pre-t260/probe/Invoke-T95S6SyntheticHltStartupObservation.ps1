...
$binary = Join-Path $build 'runner-native-adapter-observation.exe'
...
$artifactManifest = [ordered]@{
    schema = 'runner.synthetic-hlt-startup-package.v1'
...
set "RUNNER_HOST_EXCLUDE_DRIVES="
set "RUNNER_HOST_INCLUDE_DRIVES="
set "RUNNER_ADAPTER_PROFILE=$profile"
set "RUNNER_ADAPTER_ROOT=$guest"
cd /d "$evidence"
...
$record = [ordered]@{
    schema = 'runner.t95-s6.synthetic-hlt-startup-observation.v1'
