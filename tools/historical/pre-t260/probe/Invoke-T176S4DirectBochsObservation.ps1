...
$environmentValues = [ordered]@{
    ...
    RUNNER_ADAPTER_ROOT = $rootPath
    RUNNER_ADAPTER_LAUNCH_KIND = $LaunchKind
    RUNNER_ADAPTER_LAUNCH_TAIL = $LaunchTail
    RUNNER_ADAPTER_BRIDGE = '1'
}
...
$record = [ordered]@{
    schema = 'runner.direct-bochs-observation.v1'
