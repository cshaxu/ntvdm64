...
$names = @(
    ...
    'bx_ntvdm_dem_virtual_namespace_backend_v1.c',
    'bx_ntvdm_dem_virtual_mutation_backend_v1.c',
    'bx_ntvdm_dem_virtual_metadata_backend_v1.c',
    'bx_ntvdm_dem_fcb_overlay_backend_v1.c',
    ...
    'bx_ntvdm_dem_fcb_path_route_partition_v1.c',
