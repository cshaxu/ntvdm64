...
$sourceRelatives = @(
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_boot_namespace_plane_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_boot_namespace_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_bop_sequence_observation_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_command_boot_input_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_bootstrap_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_launch_execution_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_lifecycle_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_execution_lifecycle_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_stream_session_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_child_backend_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_child_redirection_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_command_console_capability_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_console_keyboard_provider_v1.c',
    'src\bx-vdm\bx_ntvdm_cmd_keyboard_layout_service.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_profile_consumer_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_cmdinfo_v1.c',
    'src\bx-vdm\bx_ntvdm_cmd_set_info_service.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_launch_plane_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_plane_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_package_facade_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_package_session_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_command_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_redir_package_facade_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_debugger_package_facade_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_top_level_package_facade_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_machine_bop_facade_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_system_plane_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_cli_unavailable_provider_v1.c',
    'src\bx-vdm\bx_ntvdm_dem_dpb_service.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_clock_service_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_check_path_service_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_drive_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_error_lock_plane_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fastio_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_search_service_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_computer_name_service_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_overlay_namespace_view_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_overlay_mutation_backend_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_overlay_metadata_backend_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_overlay_resolver_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_overlay_namespace_backend_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_overlay_handle_backend_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_virtual_metadata_backend_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_overlay_backend_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_local_file_backend_v1.c',
    'src\bx-vdm\bx_ntvdm_dem_cwd_service_v2.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_full_dpb_service_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_gset_plane_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_drive_view_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_media_id_service_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_volume_provider_v1.c',
    'src\bx-vdm\bx_ntvdm_dem_hard_error_service.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_ioctl_metadata_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_raw_media_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_misc_plane_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_handle_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_handle_route_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_handle_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_io_route_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_wildcard_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_fcb_path_route_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_namespace_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_namespace_identity_observation_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_namespace_route_partition_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_search_partition_v1.c',
    ...
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_readonly_namespace_failure_provider_v1.c',
    'src\bx-vdm\bop-v1\bx_ntvdm_dem_open_observation_v1.c',
