...
$seed = Join-Path $repository 'tools\probe\Invoke-T197S6MinimalMachineLinkProbe.ps1'
...
$includeRoots = @('src', 'src\cli', 'src\bx-vdm', 'src\bx-mantle', 'refs\bochs', 'refs\bochs\instrument\stubs', 'src\bx-core', 'refs\bochs\iodev')
...
$record = [ordered]@{
    ...
    seedBuild = 'tools/probe/Invoke-T197S6MinimalMachineLinkProbe.ps1 -WholeCpu5Core -HostArchitecture ' + $HostArchitecture
    fixture = [ordered]@{
