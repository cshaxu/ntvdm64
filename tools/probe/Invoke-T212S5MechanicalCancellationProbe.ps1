...
$includes = @('src','refs\bochs','refs\bochs\instrument\stubs','src\bx-core','src\bx-core\cpu','src\bx-mantle','src\bx-vdm','refs\bochs\iodev') | ForEach-Object { '/I "' + (Join-Path $root $_) + '"' }
