...
$sourcePaths = [ordered]@{
    selector_c = Join-Path $repository 'upstream\opennt\base\mvdm\inc\bop.h'
    selector_asm = Join-Path $repository 'upstream\opennt\base\mvdm\inc\BOP.INC'
    dos = Join-Path $repository 'upstream\opennt\base\mvdm\inc\dossvc.h'
    command = Join-Path $repository 'upstream\opennt\base\mvdm\inc\cmdsvc.h'
    xms = Join-Path $repository 'upstream\opennt\base\mvdm\inc\xmssvc.h'
    dpmi = Join-Path $repository 'upstream\opennt\base\mvdm\inc\dpmi.h'
    redir = Join-Path $repository 'upstream\opennt\base\mvdm\inc\rdrsvc.h'
    debugger = Join-Path $repository 'upstream\opennt\base\mvdm\inc\dbgsvc.h'
    bios_definitions = Join-Path $repository 'upstream\opennt\base\mvdm\softpc.new\base\inc\bios.h'
    bios_table = Join-Path $repository 'upstream\opennt\base\mvdm\softpc.new\base\bios\bios.c'
}
...
$record = [ordered]@{
    ...
    source_tree = 'upstream/opennt/base/mvdm'
