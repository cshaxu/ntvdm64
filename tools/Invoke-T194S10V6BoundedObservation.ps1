...
if ($profileText -notmatch '"schema"\s*:\s*"ntdos64-byob-profile-v6"' -or
...
$inputRecord = [ordered]@{
    schema = 'ntdos64.t194.v6-one-slot-observation-inputs.v1'
...
try {
    ...
    $record = [ordered]@{
        schema = 'ntdos64.t194.v6-one-slot-observation.v1'
