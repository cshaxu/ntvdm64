...
int main(void) {
    ...
    for(n=0;n<17;n++) { uint8_t b[4]={0xc4,0xc4,0x54,(uint8_t)n};
        ...
        bad|=r.service!=n || r.component==BX_NTVDM_COMMAND_COMPONENT_NONE;
        bad|=r.disposition!=((n==3)?BX_NTVDM_COMMAND_PLANE_ORIGINAL_NOOP:((n==6||n==8||n==10)?BX_NTVDM_COMMAND_PLANE_EXPLICIT_UNAVAILABLE:BX_NTVDM_COMMAND_PLANE_DEFERRED)); }
