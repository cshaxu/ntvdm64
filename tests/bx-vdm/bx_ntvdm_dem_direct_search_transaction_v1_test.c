...
int main(void)
{
    ...
    bx_ntvdm_search_transaction_v1 search; bx_ntvdm_search_query_v1 query; static bx_ntvdm_host_namespace_entry_v1 entries[BX_NTVDM_HOST_NAMESPACE_V1_MAX_ENTRIES]; bx_ntvdm_exception_event_v1 event = {
