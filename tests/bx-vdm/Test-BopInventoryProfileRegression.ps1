...
$path=Join-Path $RepositoryRoot 'artifacts\analysis\opennt-bop-inventory-005-20260811-001\opennt-bop-inventory.json'
...
$families=@{BOP_DOS=74;BOP_CMD=18;BOP_XMS=12;BOP_DPMI=25;BOP_REDIR=49;BOP_DEBUGGER=16}
...
Write-Output 'Immutable BOP inventory/profile regression verified: selectors=16 service-identities=194 BIOS-forms=349'
