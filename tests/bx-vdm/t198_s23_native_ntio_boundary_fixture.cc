...
int main()
{
  ...
  return t198_s23_native_ntio_boundary_observed_first_generic_ud() && generic_valid &&
    ...
    terminal.captured_physical_address==0x1370u && terminal.captured_byte_count==32u?0:2;
}
