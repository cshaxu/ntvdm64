...
#endif
  byob_profile_selection p; byob_launch_plan_v2 launch; bx_ntvdm_boot_namespace_composition_v1 c; bx_ntvdm_native_bop_composition_v1 native_bop; bx_ntvdm_host_drive_snapshot_v1 drives; bx_ntvdm_preentry_input_v1 preentry; uint8_t drive_types[26]={0};
