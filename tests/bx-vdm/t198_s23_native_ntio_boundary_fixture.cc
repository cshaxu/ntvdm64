...
int main()
{
  ...
  return t198_s23_native_ntio_boundary_observed_first_generic_ud() && generic_valid &&
    ...
    terminal.captured_physical_address==0x1370u && terminal.captured_byte_count==32u && history_count==8u && transition_valid && provenance_valid && provenance.predecessor_valid && provenance.stack_valid &&
