...
$header = Get-Content (Join-Path $root 'src/bx-vdm/bx_ntvdm_ntio_preentry_v1.h') -Raw
$source = Get-Content (Join-Path $root 'src/bx-vdm/bx_ntvdm_ntio_preentry_v1.cc') -Raw
