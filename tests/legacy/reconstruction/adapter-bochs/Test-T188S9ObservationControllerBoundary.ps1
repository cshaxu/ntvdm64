...
$manifest = Join-Path $bundle 'runner-bochs-engine-bundle-v1.txt'
...
foreach ($asset in @('runner-bochs.exe', 'ROM\BIOS-bochs-latest', 'ROM\VGABIOS-lgpl-latest', 'ROM\runner-post-handoff.rom')) {
