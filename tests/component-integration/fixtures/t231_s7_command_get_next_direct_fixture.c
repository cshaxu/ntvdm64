...
int main(void)
{
    fixture_context context; runtime_exception_event event; runtime_cpu_state cpu;
    runtime_cpu_result result; runtime_command_misc_session session, retry_session, batch_session, pif_session; CMDINFO *info;
