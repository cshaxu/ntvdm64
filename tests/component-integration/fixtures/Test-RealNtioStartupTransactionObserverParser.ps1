...
if ($tool.Contains("broadInterceptorObserved = `$log -match 'runner adapter ")) { throw 'Observer still conflates passive adapter BOP observations with a broad interceptor.' }
