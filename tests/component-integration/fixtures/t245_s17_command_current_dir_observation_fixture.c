...
int main(void)
{
    static ram_t ram; struct runtime_generic_ud_event event; struct runtime_generic_ud_outcome outcome; struct runtime_command_current_dir_observation value; uint32_t address = ((uint32_t)0x00a7u << 4) + 0x13f3u;
