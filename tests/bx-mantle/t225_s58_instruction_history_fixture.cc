...
int main(void)
{
  ...
  runtime_instruction_history_record_v1 record;
  runtime_finite_run_status status;
  uint32_t count;

  if (!runtime_mantle_instruction_history_v1_configure(0u) ||
      runtime_mantle_instruction_history_v1_count() != 0u) return 1;
