...
with `xmssvc.h` (`E2661ECF606B903E4C3053C4E6FE8197F4F4B15DDE81393FB6FD508F09BCCEBE`). The inspected handlers are `xmsa20.c`
...
3. **S4 — UMB provider completion:** conditional on S3 admission only:
   ...
   admitted; see the [S3 decision](../../../artifacts/documentation-archive/20260910/etc/research/t205-s3-c3-umb-machine-admission-decision-001.md).
