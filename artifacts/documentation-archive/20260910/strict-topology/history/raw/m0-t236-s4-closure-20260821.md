...
See the complete [S4 disposition evidence](../../artifacts/documentation-archive/20260910/etc/evidence/t236-s4-p4-dasd-ioctl-disposition-closure-001.md), the earlier [P3 VHDX evidence](../../artifacts/documentation-archive/20260910/etc/evidence/t236-s4-p3-authorized-vhdx-raw-volume-success-001.md), and [the T236 plan](../etc/operations/m0-t236-dem-command-minimum-source-recovery-plan.md).
