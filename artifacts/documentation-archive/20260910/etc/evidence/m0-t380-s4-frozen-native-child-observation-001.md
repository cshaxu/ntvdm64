...
- `observation-t380-s4-native-child-frozen.txt` (historical raw report not retained)
- `observation-t380-s4-native-child-frozen.txt.bop-return.txt` (historical raw trace not retained)
- `observation-t380-s4-native-child-frozen.txt.dem-open.txt` (historical raw trace not retained)
- `observation-t380-s4-native-child-frozen.txt.console.txt` (historical raw trace not retained)
