...
> baseline, and active packet are maintained only in [../STATUS.md](../../../states/CURRENT.md).
> This expanded ledger is retained as evidence during the migration documented
> in [../etc/operations/governance-migration.md](../../operations/governance-migration.md).
